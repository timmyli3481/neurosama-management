...
export type EventFragmentFragment = (
  { __typename?: 'Event', matches: Array<(
    ...
    { __typename?: 'TeamEventParticipation' }
    & { ' $fragmentRefs'?: { 'TeamEventParticipationCoreFragment': TeamEventParticipationCoreFragment } }
  )> }
  & { ' $fragmentRefs'?: { 'EventCoreFragmentFragment': EventCoreFragmentFragment } }
) & { ' $fragmentName'?: 'EventFragmentFragment' };

export type TeamEventParticipationCoreFragment = { __typename?: 'TeamEventParticipation', season: number, eventCode: string, teamNumber: number, team: { __typename?: 'Team', number: number, name: string } } & { ' $fragmentName'?: 'TeamEventParticipationCoreFragment' };
...
export type TeamMatchParticipationCoreFragment = { __typename?: 'TeamMatchParticipation', season: number, eventCode: string, matchId: number, alliance: Alliance, allianceRole: AllianceRole, station: Station, teamNumber: number, team: { __typename?: 'Team', number: number, name: string } } & { ' $fragmentName'?: 'TeamMatchParticipationCoreFragment' };
